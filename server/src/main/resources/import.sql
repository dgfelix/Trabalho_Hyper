...
INSERT into tb_forma_pgto(payment_type, description) VALUES ('PIX', 'pagamento pix');
...
-- Inserindo produtos - DRONES (category_id = 1)
-- drone1..drone4: quatro imagens disponíveis para cinco drones; DJI e Xiaomi compartilham drone1
...
INSERT INTO tb_product (name, description, price, image_path, category_id)
VALUES ('Drone Xiaomi FIMI X8SE', 'Câmera 4K, 33 minutos de voo, GPS Inteligente - Marca: Xiaomi, Modelo: FIMI X8SE', 2500.00, 'drone1.png', 1);

-- Inserindo produtos - SMARTWATCHES (category_id = 2)
-- Atenção: arquivo real é Smarwatch2.png (sem o 't' em Smar)
INSERT INTO tb_product (name, description, price, image_path, category_id)
...
INSERT INTO tb_product (name, description, price, image_path, category_id)
VALUES ('Smartwatch Samsung Galaxy Watch 5', 'Monitor de Sono, Resistente à Água, Bluetooth - Marca: Samsung, Modelo: Galaxy Watch 5', 2300.00, 'Smarwatch2.png', 2);
...
INSERT INTO tb_product (name, description, price, image_path, category_id)
VALUES ('Smartwatch Xiaomi Mi Band 7', 'Tela AMOLED, Monitor de Atividades, 14 Dias de Bateria - Marca: Xiaomi, Modelo: Mi Band 7', 499.00, 'Smartwatch3.png', 2);
...
-- Dados de usuário
-- Senha BCrypt de todos os usuários: mesma hash usada por admin e test
INSERT INTO tb_user(display_name, username, password) VALUES ('Administrador', 'admin','$2a$10$.PVIfB07x.SfMYTcToxL0.yxcLWU0GbS2NUO1W1QAvqMm/TsFhVem');
INSERT INTO tb_user(display_name, username, password) VALUES ('Teste', 'test','$2a$10$.PVIfB07x.SfMYTcToxL0.yxcLWU0GbS2NUO1W1QAvqMm/TsFhVem');
INSERT INTO tb_user(display_name, username, password) VALUES ('Teste1', 'test1','$2a$10$.PVIfB07x.SfMYTcToxL0.yxcLWU0GbS2NUO1W1QAvqMm/TsFhVem');

-- Formas de pagamento
INSERT INTO tb_forma_pgto(payment_type, description) VALUES ('PIX', 'Pagamento via Pix - aprovação imediata');
INSERT INTO tb_forma_pgto(payment_type, description) VALUES ('CREDITO', 'Cartão de Crédito - parcelamento em até 12x');
INSERT INTO tb_forma_pgto(payment_type, description) VALUES ('DEBITO', 'Cartão de Débito - desconto à vista');
INSERT INTO tb_forma_pgto(payment_type, description) VALUES ('BOLETO', 'Boleto Bancário - vencimento em 3 dias úteis');
